...
public class CompanyController {
	...
	public String goMain() {
		return "redirect:/main"; // 메인페이지 리다이렉트 이동
	}

	@RequestMapping("/main")
	public String main(HttpServletRequest request) {
		return "main"; // 메인페이지 포워드이동 http://localhost:8882/main
	}

	@RequestMapping("/goMonitoring.do")
	public String goMonitoring() {
		return "redirect:/monitoring"; // 양식장 모니터링 리다이렉트 이동
	}

	@RequestMapping("/monitoring")
	public String monitoring() {
		return "monitoring"; // 양식장 모니터링 포워드이동 http://localhost:8882/main
	}
	...
	public String goHistory() {
		return "redirect:/history"; // 수질 기록 페이지 리다이렉트 이동
	}
	
	@RequestMapping("/history")
	public String history() {
		return "history"; // 수질 기록 페이지 포워드이동 http://localhost:8882/main
	}
